...
%   'torque_cmd'  : [ankle_torque; hip_torque] commanded joint torques
%                   before motor noise is added
%
% Rika Sugimoto Dimitrova (rikasd@mit.edu)
% 2024-02-10
% Adapted code from Jongwoo Lee, PhD. and Kaymie Shiozawa, PhD. (Shiozawa et al. 2021)
%
% Modified:
% 2025-07-02 - re-format motorNoiseRatio as a normalized 2D array applied
%              to motorNoise
...
motorNoiseRatio_norm = [motorNoiseRatio; 1]./norm([motorNoiseRatio; 1]);
motorNoise = motorNoiseRatio_norm.*motorNoise;
...
output_struct.torque_cmd(1,:) = decimate(torque(1,:),r);
output_struct.torque_cmd(2,:) = decimate(torque(2,:),r);
